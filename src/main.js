...
class AnantaApp {
  ...
  // Debounce ScrollTrigger.update to avoid excessive calls
  const debouncedUpdate = debounce(() => ScrollTrigger.update(), 50)
  this.lenis.on('scroll', debouncedUpdate)

  // Use native RAF for Lenis
