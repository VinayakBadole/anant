...
class DualBrandLogoMask {
  ...
  setupEventListeners() {
    ...
    window.addEventListener('wheel', this._throttledScroll, { passive: true })
    window.addEventListener('touchmove', this._throttledScroll, { passive: true })
  ...
  cleanup() {
    ...
    if (this._throttledScroll) {
      window.removeEventListener('wheel', this._throttledScroll)
      window.removeEventListener('touchmove', this._throttledScroll)
